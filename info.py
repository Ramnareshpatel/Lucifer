...
API_ID = int(environ['16225550'])
API_HASH = environ['160343c3d2eaf54b556ad5a7c72a3b83']
BOT_TOKEN = environ['5312771340:AAHj1pcE334wqVLfE26aNMbalRcBW6DHPME']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001265527593').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001741562670))
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", f"🏷 <b>Tɪᴛʟᴇ</b> : <b>{title} {year}</b>
